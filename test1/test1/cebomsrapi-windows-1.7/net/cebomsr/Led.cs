...
{
    /// <summary>
    /// Offers functionality of for LED's. Instances can be retrieved from Leds
    ...
    public sealed class Led
    {
        ...
        internal Led(Device device, uint interfaceId, int index)
        {
            _device = device;
        ...
        /// </summary>
        public bool Enabled { set { SystemConnector.SetLed(_device.Handle, _interfaceId, value); } }
