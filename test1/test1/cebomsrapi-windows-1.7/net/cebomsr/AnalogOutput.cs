...
namespace CeboMsrNet
{
    ...
    /// is not possible. Instances can be retrieved from AnalogOutputs
    /// of the respective Device class.
    /// </summary>
    public sealed class AnalogOutput : IOutput
    {
        ...
        internal AnalogOutput(Device device, uint interfaceId, int index)
        {
            _device = device;
            ...
            for (int i = 0; ; ++i)
            {
                ...
                _supportedRanges.Add(new Range(rangeId, minMax[0], minMax[1], 0));
            }
        }
        ...
        /// </summary>
        public float Value { set { SystemConnector.WriteAnalogOutput(_device.Handle, _interfaceId, value); } }
