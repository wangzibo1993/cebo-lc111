...
{
    /// <summary>
    /// Offers functionality for current sources. Instances can be retrieved from
    /// CurrentSources of the respective Device instance.
    /// </summary>
    public sealed class CurrentSource
    {
        ...
        internal CurrentSource(Device device, uint interfaceId, int index)
        {
            _device = device;
        ...
        /// <summary>
        /// The real current of the constant current source in micro ampere.
        /// </summary>
        public float ReferenceCurrent { get { return SystemConnector.GetReferenceCurrent(_device.Handle, _interfaceId); } }
